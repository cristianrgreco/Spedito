...
and exposes **Accept all** and **Dismiss all** in that section's header; row
selection is a convenience, not the only discoverable way to continue. In the
Backlog, the same actions sit in a full-width proposed-ticket group row between
