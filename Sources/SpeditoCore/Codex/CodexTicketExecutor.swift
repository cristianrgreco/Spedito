...
public enum CodexTechLeadReviewer {
  ...
  public static func prompt(
    ...
    return """
      ...
      Inspect the exact immutable workspace using repository and file reads only, then return the
      bounded review described above. Do not run checks, launch the product or demo, browse external
      sources, or request permissions. Treat a materially inaccurate canonical knowledge proposal
      as a blocker; minor incompleteness can be noted without preventing demonstration.
      """
  }
