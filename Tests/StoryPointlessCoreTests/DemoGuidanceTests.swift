...
struct DemoGuidanceTests {
  ...
  func deliveryGuidance() {
    ...
    #expect(instructions.contains("accept the app-supplied port"))
  ...
  func techLeadGuidance() {
    ...
    #expect(instructions.contains("product surface rather than"))
    ...
    #expect(instructions.contains("verified Environments entry point"))
